...
Thanks for your interest! `geoscales` is part of the optimal2050
modeling stack and is developed alongside its time-domain companion
...
- Reference related `timescales` PRs in the description when changes
