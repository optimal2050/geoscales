...
![](reference/figures/README-demo-map-1.png)
...
![](reference/figures/README-demo-icicle-1.png)

See
[`vignette("geoscales")`](https://optimal2050.github.io/geoscales/r/articles/geoscales.md)
for the 5-minute tour, and the [visualization
...
pass a point of view through and record it in `@meta`.
